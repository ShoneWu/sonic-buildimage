...
CPLD1_I2C_PATH = "/sys/bus/i2c/devices/13-0061/"
CPLD2_I2C_PATH = "/sys/bus/i2c/devices/14-0062/"
CPLD3_I2C_PATH = "/sys/bus/i2c/devices/17-0063/"
...
class Sfp(SfpBase):
    ...
    PLATFORM = "x86_64-accton_as7946_74xkb-r0"
    HWSKU = "Accton-AS7946-74XKB"
    ...
    def get_reset_status(self):
        ...
        if 1 <= self._port_num <= 10:
            reset_path = "{}{}{}".format(CPLD1_I2C_PATH, '/module_reset_', self._port_num)
        else:
            return False
    ...
    def tx_disable(self, tx_disable):
        ...
        if self.sfp_type == QSFP_TYPE:
            ...
            if 1 <= self._port_num <= 25:
                disable_path = "{}{}{}".format(CPLD1_I2C_PATH, '/module_tx_disable_', self._port_num)
            elif 26 <= self._port_num <= 50:
                disable_path = "{}{}{}".format(CPLD2_I2C_PATH, '/module_tx_disable_', self._port_num)
            elif 51 <= self._port_num <= 74:
    ...
    def get_presence(self):
        ...
        """
        if 1 <= self._port_num <= 25:
            present_path = "{}{}{}".format(CPLD1_I2C_PATH, '/module_present_', self._port_num)
        elif 26 <= self._port_num <= 50:
