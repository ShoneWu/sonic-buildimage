...
class Tlv(eeprom_tlvinfo.TlvInfoDecoder):
    ...
    def __init__(self):
        ...
        os.system("cp -f /sys/devices/platform/as7946_74xkb_sys/eeprom /var/cache/sonic/decode-syseeprom/syseeprom_cache")
        self._eeprom_path = "/sys/devices/platform/as7946_74xkb_sys/eeprom"
