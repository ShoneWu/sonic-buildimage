...
HWMON_I2C_PATH = ["/sys/bus/i2c/devices/10-0059/", "/sys/bus/i2c/devices/9-0058/"]
CPLD_I2C_PATH = ["/sys/bus/i2c/devices/10-0051/", "/sys/bus/i2c/devices/9-0050/"]
...
class Psu(PsuBase):
    ...
    def __init__(self, psu_index=0):
        ...
        self.hwmon_path = HWMON_I2C_PATH[self.index]
        self.cpld_path = CPLD_I2C_PATH[self.index]
